...
<?php
      ...
      else if(isset($_POST['show']))
      {
          ...
          {
            echo "<table style="."width:25%"."> <tr> <th>ID</th> <th>Name</th> <th>Email</th> <th>Operation</th> </tr>";
...
<br>
    <div style="background-color:#B69A26; display:inline-block; padding:20px; width:50% margin:auto; ">
